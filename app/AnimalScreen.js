...
const AnimalScreen = ({ navigation }) => {
  ...
  const animals = ['dog', 'cat', 'lion', 'tiger', 'elephant']; // Example list of animal names
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={{ fontSize: 18, color: 'black',margin:'2%' }}>Unscramble the letters to form an animal name:</Text>
      {/* <Text style={{ fontSize: 20, color: 'black' }}>{scrambledLetters.join('')}</Text> */}
